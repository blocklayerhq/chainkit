...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 10, 21, 17, 9, 30, 764306238, time.UTC),
		},
		...
		"/cmd/{{ .Name }}cli": &vfsgen۰DirInfo{
			name:    "{{ .Name }}cli",
			modTime: time.Date(2018, 10, 21, 17, 9, 10, 64148698, time.UTC),
		},
		...
		"/cmd/{{ .Name }}d": &vfsgen۰DirInfo{
			name:    "{{ .Name }}d",
			modTime: time.Date(2018, 10, 21, 17, 9, 2, 392292909, time.UTC),
		},
		...
		"/k8s": &vfsgen۰DirInfo{
			name:    "k8s",
			modTime: time.Date(2018, 10, 21, 17, 6, 19, 329746457, time.UTC),
		},
		"/k8s/.helmignore": &vfsgen۰CompressedFileInfo{
			name:             ".helmignore",
			modTime:          time.Date(2018, 10, 21, 17, 1, 7, 996416357, time.UTC),
		...
		"/k8s/Chart.yaml": &vfsgen۰FileInfo{
			name:    "Chart.yaml",
			modTime: time.Date(2018, 10, 21, 17, 1, 7, 996062149, time.UTC),
		...
		"/k8s/templates": &vfsgen۰DirInfo{
			name:    "templates",
			modTime: time.Date(2018, 10, 21, 17, 1, 7, 998950350, time.UTC),
		},
		"/k8s/templates/NOTES.txt": &vfsgen۰CompressedFileInfo{
			name:             "NOTES.txt",
			modTime:          time.Date(2018, 10, 21, 17, 1, 7, 997060220, time.UTC),
		...
		"/k8s/templates/_helpers.tpl": &vfsgen۰CompressedFileInfo{
			name:             "_helpers.tpl",
			modTime:          time.Date(2018, 10, 21, 17, 1, 7, 999089494, time.UTC),
		...
		"/k8s/templates/configmap.yaml": &vfsgen۰CompressedFileInfo{
			name:             "configmap.yaml",
			modTime:          time.Date(2018, 10, 21, 17, 1, 7, 998770722, time.UTC),
		...
		"/k8s/templates/service.yaml": &vfsgen۰CompressedFileInfo{
			name:             "service.yaml",
			modTime:          time.Date(2018, 10, 21, 17, 17, 34, 15050158, time.UTC),
		...
		"/k8s/templates/statefulset.yml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 10, 21, 17, 1, 7, 998013522, time.UTC),
		...
		"/k8s/templates/storageclass.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 10, 21, 17, 1, 7, 997415835, time.UTC),
		...
		"/k8s/values.yaml": &vfsgen۰CompressedFileInfo{
			name:             "values.yaml",
			modTime:          time.Date(2018, 10, 21, 17, 17, 55, 134437895, time.UTC),
