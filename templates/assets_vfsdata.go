...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 10, 30, 23, 10, 22, 37806141, time.UTC),
		},
		"/.gitignore": &vfsgen۰CompressedFileInfo{
			name:             ".gitignore",
			modTime:          time.Date(2018, 11, 30, 22, 32, 41, 27580210, time.UTC),
			uncompressedSize: 215,

			compressedContent: []byte(""),
		},
		"/Dockerfile.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "Dockerfile.tmpl",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 827279828, time.UTC),
		...
		"/Gopkg.lock": &vfsgen۰CompressedFileInfo{
			name:             "Gopkg.lock",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 828341229, time.UTC),
		...
		"/Gopkg.toml": &vfsgen۰CompressedFileInfo{
			name:             "Gopkg.toml",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 829187320, time.UTC),
		...
		"/app.go.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "app.go.tmpl",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 830655426, time.UTC),
		...
		"/cmd": &vfsgen۰DirInfo{
			name:    "cmd",
			modTime: time.Date(2018, 10, 23, 19, 53, 18, 831582094, time.UTC),
		},
		"/cmd/{{ .Name }}cli": &vfsgen۰DirInfo{
			name:    "{{ .Name }}cli",
			modTime: time.Date(2018, 10, 23, 19, 53, 18, 830853938, time.UTC),
		},
		"/cmd/{{ .Name }}cli/main.go.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "main.go.tmpl",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 831512768, time.UTC),
		...
		"/cmd/{{ .Name }}d": &vfsgen۰DirInfo{
			name:    "{{ .Name }}d",
			modTime: time.Date(2018, 10, 23, 19, 53, 18, 831632307, time.UTC),
		},
		"/cmd/{{ .Name }}d/main.go.tmpl": &vfsgen۰CompressedFileInfo{
			name:             "main.go.tmpl",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 832109147, time.UTC),
		...
		"/k8s": &vfsgen۰DirInfo{
			name:    "k8s",
			modTime: time.Date(2018, 10, 23, 19, 53, 18, 835912468, time.UTC),
		},
		"/k8s/.helmignore": &vfsgen۰CompressedFileInfo{
			name:             ".helmignore",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 833139042, time.UTC),
		...
		"/k8s/Chart.yaml": &vfsgen۰FileInfo{
			name:    "Chart.yaml",
			modTime: time.Date(2018, 10, 23, 19, 53, 18, 833489624, time.UTC),
		...
		"/k8s/templates": &vfsgen۰DirInfo{
			name:    "templates",
			modTime: time.Date(2018, 10, 23, 19, 53, 18, 835689003, time.UTC),
		},
		"/k8s/templates/NOTES.txt": &vfsgen۰CompressedFileInfo{
			name:             "NOTES.txt",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 833910249, time.UTC),
		...
		"/k8s/templates/_helpers.tpl": &vfsgen۰CompressedFileInfo{
			name:             "_helpers.tpl",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 834502543, time.UTC),
		...
		"/k8s/templates/configmap.yaml": &vfsgen۰CompressedFileInfo{
			name:             "configmap.yaml",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 834744081, time.UTC),
		...
		"/k8s/templates/service.yaml": &vfsgen۰CompressedFileInfo{
			name:             "service.yaml",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 835204826, time.UTC),
		...
		"/k8s/templates/statefulset.yml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 835621380, time.UTC),
		...
		"/k8s/templates/storageclass.yaml": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 835842885, time.UTC),
		...
		"/k8s/values.yaml": &vfsgen۰CompressedFileInfo{
			name:             "values.yaml",
			modTime:          time.Date(2018, 10, 23, 19, 53, 18, 836414059, time.UTC),
	...
	fs["/cmd/{{ .Name }}cli"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		fs["/cmd/{{ .Name }}cli/main.go.tmpl"].(os.FileInfo),
	}
	fs["/cmd/{{ .Name }}d"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		fs["/cmd/{{ .Name }}d/main.go.tmpl"].(os.FileInfo),
	}
	fs["/k8s"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		fs["/k8s/.helmignore"].(os.FileInfo),
		fs["/k8s/Chart.yaml"].(os.FileInfo),
		fs["/k8s/templates"].(os.FileInfo),
		fs["/k8s/values.yaml"].(os.FileInfo),
	}
	fs["/k8s/templates"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		fs["/k8s/templates/NOTES.txt"].(os.FileInfo),
		fs["/k8s/templates/_helpers.tpl"].(os.FileInfo),
		fs["/k8s/templates/configmap.yaml"].(os.FileInfo),
		fs["/k8s/templates/service.yaml"].(os.FileInfo),
		fs["/k8s/templates/statefulset.yml"].(os.FileInfo),
		fs["/k8s/templates/storageclass.yaml"].(os.FileInfo),
	}
